...
- `npm run dev` → run project with Node.js

## Features

- ESLint 9.x with flat config

- Prettier 3.x configured with StandardJS-like style (single quotes, no semicolons, 2-space indentation)

- GitHub Actions for CI (lint, format, test)
